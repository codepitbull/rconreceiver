...
public class RconToMqttConfig {
    ...
    public boolean equals(Object o) {
        ...
        RconToMqttConfig that = (RconToMqttConfig) o;
        return getPollingIntervalMillis() == that.getPollingIntervalMillis() && getMaxPollingErrorsBeforeRemoval() == that.getMaxPollingErrorsBeforeRemoval() && getPublishChangedDataOnly() == that.getPublishChangedDataOnly();
    }

    @Override
    public int hashCode() {
        return Objects.hash(getPollingIntervalMillis(), getMaxPollingErrorsBeforeRemoval(), getPublishChangedDataOnly());
    }
    ...
    public String toString() {
        return "RconToMqttConfig{" +
                ...
                ", maxPollingErrorsBeforeRemoval=" + maxPollingErrorsBeforeRemoval +
                ", publishChangedDataOnly=" + publishChangedDataOnly +
                '}';
    }
}
